...
public class Liste extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List lpro;
        try {
            lpro = new Myclass().find("select * from Produit", con);
            retour.put("listpro",lpro);
            ModelView md=new ModelView(retour,"Pages/template","");
            
            request.setAttribute("liste", lpro);
            ServletContext context= this.getServletContext();
            RequestDispatcher dispatch = context.getRequestDispatcher("Pages/template.jsp");
